...
public class MiniMaxAI extends ConnectFourPlayer {
    public MiniMaxAI(String player_name, char difficulty, boolean automaticPlayer) {
    ...
    public void makeMove(ConnectFourGame game ) {
        ...
        Random r = new Random();
        while ( !game.dropPiece(r.nextInt(6)) )
            ;
